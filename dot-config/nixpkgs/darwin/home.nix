...
in
{
  ...
  home.file.kittyStartup = {
    ...
    text = ''
      ...
      launch --type overlay zsh -c "${config.xdg.configHome}/jxa/waitapp.js 'DisplayLink Manager.app' && sleep 2 && ${config.xdg.configHome}/jxa/resize_app.js kitty >& ~/log/kresize.log"
    '';
  };
