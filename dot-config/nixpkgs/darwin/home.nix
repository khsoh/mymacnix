...
in {
  ...
  home.file.kitty = {
    ...
    source = pkgs.fetchFromGitHub {
      owner = ghcfg.username;
      repo = "kittyconf";
      rev="f230d3d6e6c49ac903f035a9eb44257085b79cda";
      sha256="sha256-Qn4TfMcj4mRrTGQAFEu0pxJa7iz2vY7dNffdbPBA4UU=";
      #sha256 = lib.fakeSha256;
    };
    recursive = true;
  };
  ...
  home.file.nvim = {
    ...
    source = pkgs.fetchFromGitHub {
      owner = ghcfg.username;
      repo = "kickstart.nvim";
      rev="c7ccac35b6dcbde0978d6a18692cb5f9e8ee7f98";
      sha256="sha256-cstASuqprKbixLMlBXeAC53kufPixCPmvnoF6K5TIN4=";
      #sha256 = lib.fakeSha256;
    };
    recursive = true;
  };
